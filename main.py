...
df = pd.read_csv(r"C:\Users\arnav\Downloads\C111-main\c111\data1.csv")
...
fig.add_trace(go.Scatter(x=[first_std_deviation_end, first_std_deviation_end],y=[0,0.17],mode="lines",name="Mean of sample 2"))
fig.show()
